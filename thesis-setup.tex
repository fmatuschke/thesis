...
% **************************************************
\newcommand{\thesisTitle}{Nerve Fiber Modeling and 3D-PLI Simulations of a Tilting Polarization Microscope}
\newcommand{\thesisName}{Felix Matuschke}
\newcommand{\thesisBirthPlace}{Meschede}
\newcommand{\thesisSubject}{Inaugural-Dissertation}
...
\newcommand{\thesisUniversityStreetAddress}{Universit{\"a}tsstra{\ss}e 1}
