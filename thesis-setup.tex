...
\lstdefinestyle{python}{
    ...
    keywordstyle=\color{syntax_keywords},
    commentstyle=\color{syntax_comments},
    stringstyle=\color{syntax_red},
...
% **************************************************
\usepackage{shellesc}
% \usepackage{layouts} % measure sizes in cm
\usepackage{tikz}
% \usepackage{tikz-uml}
...
% 
% \usepackage{pdftexcmds} % for externalizing names
% \makeatletter
...
\newcommand{\inputtikz}[2][false]{%
    \ifthenelse{\boolean{#1}}{ % build ext tikz
        \tikzset{external/remake next=#1}
        \input{#2.tikz}
    }{ % try loading pdf if available
        \IfFileExists{tikz/#2.pdf}{
          \includegraphics{tikz/#2.pdf}
        }{ % build ext tikz
          %  \noindent\includegraphics[width=4.2cm]{example-image}
          \IfFileExists{#2.tikz}{
             % \filename@parse{#1}
             % \tikzsetnextfilename{\filename@base}
             % \tikzexternalenable
             % \tikzset{external/force remake=#1}
            %  \tikzset{external/remake next=#1}
             % \tikzsetnextfilename{\filesum{#1.tikz}}
             \input{#2.tikz}
             % \tikzexternaldisable
          }{
             \noindent\includegraphics[width=4.2cm]{example-image}
...
\ifthenelse{\boolean{#1}}{
	\tikzifexternalizingnext{%
		...
		\pgfmathparse{#3/\ht\measure@tikzpicture}%
...
% for testing,
% \makeatletter
% \NewEnviron{sizetikz}[3][]{%
% \begin{tikzpicture}[#1]%
% \begin{pgfinterruptboundingbox}%
% \begin{scope}[opacity=0]%
% \BODY%
% \pgfsize{\tikzbbwidth}{\tikzbbheight}%
% \end{scope}%
% \end{pgfinterruptboundingbox}%
% \pgfmathparse{#2/\tikzbbwidth}%
% \edef\tikzscalewidth{\pgfmathresult}%
% \pgfmathparse{#3/\tikzbbheight}%
% \edef\tikzscaleheight{\pgfmathresult}%
% \pgfmathparse{min(\tikzscalewidth, \tikzscaleheight)}%
% \def\tikzscale{\pgfmathresult}%
% \begin{scope}[scale=\tikzscale]%
% \BODY%
% \end{scope}%
% \end{tikzpicture}%
% % \the\tikzbbwidth%
...
\newcommand{\dummy}{\textcolor{ProcessBlue}{\textbf{\{...\}}}\xspace}
% \usepackage{soul}
% \newcommand{\todo}[1]{%
%   \begingroup
...
\presetkeys%
    {todonotes}%
    {inline,backgroundcolor=ProcessBlue}{}
\makeatletter
\renewcommand{\todo}[2][]{%
  \tikzset{external/export next=false}\@todo[#1]{#2}%
}
\makeatother
...
\makeatother
% 
% \definecolor{cc21}{HTML}{9b59b6}
% \definecolor{cc22}{HTML}{3498db}
% \pgfplotscreateplotcyclelist{cc2}{cc21, cc22}
% 
% \definecolor{cc21}{HTML}{9b59b6}
% \definecolor{cc22}{HTML}{3498db}
% \pgfplotscreateplotcyclelist{cc2}{cc21, cc22}
% % 
% \definecolor{cc31}{HTML}{9b59b6}
% \definecolor{cc32}{HTML}{3498db}
% \definecolor{cc33}{HTML}{95a5a6}
% \pgfplotscreateplotcyclelist{cc3}{cc31, cc32, cc33}
% % 
% \definecolor{cc41}{HTML}{9b59b6}
% \definecolor{cc42}{HTML}{3498db}
% \definecolor{cc43}{HTML}{95a5a6}
% \definecolor{cc44}{HTML}{e74c3c}
% \pgfplotscreateplotcyclelist{cc4}{cc41, cc42, cc43, cc44}
% % 
% \definecolor{cc51}{HTML}{9b59b6}
% \definecolor{cc52}{HTML}{3498db}
% \definecolor{cc53}{HTML}{95a5a6}
% \definecolor{cc54}{HTML}{e74c3c}
% \definecolor{cc55}{HTML}{34495e}
% \pgfplotscreateplotcyclelist{cc5}{cc51, cc52, cc53, cc54, cc55}
% % 
% \definecolor{cc61}{HTML}{9b59b6}
% \definecolor{cc62}{HTML}{3498db}
% \definecolor{cc63}{HTML}{95a5a6}
% \definecolor{cc64}{HTML}{e74c3c}
% \definecolor{cc65}{HTML}{34495e}
% \definecolor{cc66}{HTML}{2ecc71}
% \pgfplotscreateplotcyclelist{cc5}{cc61, cc62, cc63, cc64, cc65, cc66}
% 
\pgfplotsset{
