...
% \newcolumntype{RM}[1]{>{\raggedleft\arraybackslash}m{#1}}
% \newcolumntype{LM}[1]{>{\raggedright\arraybackslash}m{#1}}
% \newcolumntype{CM}[1]{>{\centering\arraybackslash}m{#1}}
% 
...
\setlength{\itodolength}{\textwidth minus 12.1411pt}
\presetkeys%
    {todonotes}%
