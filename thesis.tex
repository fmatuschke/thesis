...
% \tikzexternaldisable %will be activated inside \inputtikz
%  
%                 %  mode=list and make,
...
\parttoc
% \acbarrier
\include{content/09-chapter-usecase}
% 
\cleardoublepage
\part{Discussion and Conclusion}
% \acbarrier
\include{content/10-chapter-conclusion}
%
% --------------------------
% Back matter
% --------------------------
