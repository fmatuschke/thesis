...
It is used to measure an entire brain section at a resolution of $\SI{60}{\micro\meter}$. \footnote{It is also possible to aquire images with different pixel sizes \eg{} by changing the focal length, since the setup is not fixed.}
\par
% 
