...
This imaging resolution at the \si{\milli\meter}-scale can lead to misleading results due to the models and resolution limits involved, n particular in regions of fiber crossing or fiber \say{kissing} \cite{MaierHein2017}. \todo{Markus nach dem Stil der Zitate fragen}
