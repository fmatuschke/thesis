\todo{already, also, simple, quite, ...}
\todo{vergleich von em daten oder lens mit meinen modellen}
% 
% 
% 
...
Such a dataset can also be used to learn from and improve the models applied to the lower resolution datasets, which can help in diagnosis. \\
...
Complementary imaging techniques, such as two-photon microscopy, allow the tissue to be examined at higher resolution without deforming it, but this has the disadvantage of longer measurement time.
\par
% 
