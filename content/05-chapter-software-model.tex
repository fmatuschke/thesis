...
\begin{figure}[!tbh]
	...
	\caption[cc and co]{\Acf{CC}: \raisebox{.25em}{\tikz \draw[black](0,0)--(0.275,0);} \ac{CC}, \raisebox{.25em}{\tikz \draw[blue, dash pattern=on 2.5pt off 2.5pt](0,0)--(0.275,0);} capsule}
...
% 
\begin{lstfloat}[!tb]
	\lstinputlisting[language=c++]{code/medusa.cu}
