...
\begin{figure}[!t]
    \centering
    \subcaptionbox{\label{fig:cubeBuild}\dummy}[.5\textwidth-1ex]{
...
\end{figure}
% 
Additionaly to populating a fiber bundle, an additional method to fill cubic volumes with a main fiber direction $\vv{v}$ was developed.
This method uses a populates a cube by placing the seed points before and after the cube volume.
Each fiber, correponds to two matching points, is then check if it collides with the cube.
