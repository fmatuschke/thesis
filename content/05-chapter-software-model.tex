...
\lstinputlisting[style=cpp,basicstyle=\scriptsize\ttfamily,firstline=1,lastline=44]{code/collision_detection.cpp}
\end{minipage} & \hspace{1em} &
\begin{minipage}{0.4625\textheight}
\lstinputlisting[style=cpp,basicstyle=\scriptsize\ttfamily,firstline=45,lastline=88,firstnumber=45]{code/collision_detection.cpp}
\end{minipage} \\
\hline
\end{tabular}
\end{sideways}}
