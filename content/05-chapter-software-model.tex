...
\begin{figure}[!t]
    ...
    \leavevmode\subcaption{merge}
    \end{minipage}}
    &
    \multicolumn{1}{@{}l}{
    \begin{minipage}{0.5\textwidth}
    \leavevmode\subcaption{split}
    \end{minipage}}
    \end{tabular}
...
\begin{figure}[!t]
    ...
    \leavevmode\subcaption{Boundary segment length: lower bound $phi=\SI{60}{\degree} \xrightarrow{} r_{\mathit{min}} \geq \SI{0.5773}{} \cdot l_{\mathit{mean}}$}
    \end{minipage}}
    &
    \multicolumn{1}{@{}l}{
    \begin{minipage}{0.475\textwidth}
    \leavevmode\subcaption{\label{fig:boundaryLength}Boundary segment radii: lower bound $r_{\mathit{min}} \geq \fiberRadiusMean$}
    \end{minipage}\hfill}
    \end{tabular}
