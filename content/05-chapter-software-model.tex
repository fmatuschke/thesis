...
\begin{figure}[!t]
    \centering
    \subcaptionbox{lower bound $r_{min} \geq \fiberRadiusMean $}[.49\textwidth]{
    \def\tikzheight{.42\textwidth}
    \inputtikz{gfx/model/model_circular.tikz}}
    \subcaptionbox{lower bound $phi=\SI{60}{\degree} \xrightarrow{} r_{min} \geq \SI{0.5773}{} \cdot l_{mean}$}[.49\textwidth]{
    \def\tikzheight{.42\textwidth}
