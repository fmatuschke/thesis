...
However, since all eight cores have to share the object list data, even if they only read, it is no longer possible to achieve up to eight times the speed from this point on (see later acceleration measurements \dummy).
% 
% 
% 
