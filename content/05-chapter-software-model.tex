...
% 
\paragraph{OpenMP:}
To be able to use multiple \ac{CPU}s \openmp is used. With an structer like an octree the seperation process into the new sub volumes can already be parallelised up to eight corse.
