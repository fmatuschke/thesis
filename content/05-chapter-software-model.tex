...
\begin{figure}[!t]
    ...
    \centering
    \inputtikz{gfx/model/fibe_rep.tikz}
	\caption[]{\todo{etwas besser}}
	\label{fig:fiberReb}
\end{figure}
% 
% 
...
%     % \inputtikz{gfx/model/cylinder.tikz}}
%     % \subcaptionbox{capsule}[\textwidth]{
%     % \inputtikz{gfx/model/capsule.tikz}}
...
% 
\begin{figure}[!t]
    % \def\tikzwidth{0.3\textwidth}
    \def\tikzheight{0.25\textwidth}
    \centering
    % \tikzset{external/remake next}
    \subcaptionbox{\label{fig:triGrid}2d triangular grid}[.295\textwidth]{
    \inputtikz{gfx/model/triangular_grid.tikz}\hfill}
    % \tikzset{external/remake next}
    \subcaptionbox{\label{fig:rndGrid}rnd grid}[.295\textwidth]{
    \inputtikz{gfx/model/rnd_circle_points.tikz}\hfill}
    % \tikzset{external/remake next}
    \subcaptionbox{\label{fig:crossBundle}2d filled fiber bundles}[.39\textwidth]{
    \inputtikz{gfx/model/crossing_bundle.tikz}\hfill}
...
\begin{figure}[!t]
	...
	\caption{Bending fiber along trajectory}
	\label{fig:circleBundle}
\end{figure}
% 
Filling a \say{bundle} is is done via moving the \say{cloud} of seed points along the trajectory, moving,bending/rotating smooth along its way (like a good rolercoster).
...
The distant of the seeds to their coordinate center can be scaled with the bundle \say{radii} or scale factor (set 1 for const).
% 
\section{\VCS}
% 
\begin{figure}[!t]
    ...
    \inputtikz{gfx/model/conical_capsule_bb.tikz}
    \tikzexternaldisable
...
\begin{figure}[!t]
    ...
    \inputtikz{gfx/model/oct_tree.tikz}}
    \subcaptionbox{collision 2d}[.65\textwidth]{
    \def\tikzheight{0.6\textwidth}
    \inputtikz{gfx/model/collision_tree.tikz}}
	\caption{}
	\label{fig:oct_tree}
\end{figure}
% 
...
\begin{figure}[!t]
    ...
    \subcaptionbox{merge}[.5\textwidth]{
    \inputtikz{gfx/model/model_merge.tikz}}
    \subcaptionbox{split}[.5\textwidth]{
    \inputtikz{gfx/model/model_split.tikz}}
...
\begin{figure}[!t]
    ...
    \inputtikz{gfx/model/model_circle_.tikz}}\hfill
