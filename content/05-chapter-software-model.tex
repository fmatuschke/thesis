...
Unfortunately there is no simple answer to a structure like an octree which can provide an definit answer.
...
\par
% 
At this point the colliding objects can be identified.
