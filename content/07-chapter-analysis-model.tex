...
\par
Anatomically nerve fibers have a radius of around \SI{0.5}{\micro\meter} and more in the \ac{WM} (see \cref{chap:neuro}).
This means that inside a \SI{60}{\micro\meter} thick tissue section already about \si{100} layers of nerve fibers have space.
