...
% 
To find a usable library of two fiber populations researched main attributes are listed in \cref{tab:cube2pop} \cref{tab:cube2popSoftware} contains the parameters of the additional \pymodule{fastpli.model.solver} algorithm.
% 
\begin{table}[!b]
...
\caption[Model characteristics]{Model characteristic for $\fiberRadius = \SI{1}{\micro\meter}$ different parameters. Additional \fiberRadius are listed in Appendix \dummy{}. \itodo{\segLengthFactor and \segRadiusFactor}}
% \label{fig:}
\end{figure}
...
\caption[Time development crossing.]{Time development of the model generation process of crossing fibers populations.\itodo{\segLengthFactor and \segRadiusFactor}}
% \label{fig:}
\end{figure}
% 
\begin{figure}[p]
...
\caption[Time development parallel]{Time development of the model generation process of parallel fiber populations.\itodo{\segLengthFactor and \segRadiusFactor}}
% \label{fig:}
\end{figure}
% 
