...
\par
% 
The described control mechanisms in the collision solver algorithm \code{fastpli.model.solver} (see \cref{chap:sof:modeling}) must be characterized.
...
min segment bending radii factor & $\segRadiusFactor$ & $\numlist{1;2;4;8}$\\
