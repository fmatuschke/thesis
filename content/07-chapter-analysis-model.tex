...
\caption[\code{model.Sovler} speedup]{\code{model.Sovler} speedup. The time measurements are taken after $\Delta_{\mathit{steps}}$ for the next $100$ steps for parallel $(||)$ and crossing $(\times)$ fiber configurations. \itodo{for 16, 24, 32, 48 cores}}
...
\begin{tabular}{cccc}
    ...
    \includegraphics[width=0.3\textwidth]{dev/rc1/images/cube_2pop_psi_0.30_omega_30.00_r_0.50_v0_135_.solved.png} & 
    \includegraphics[width=0.3\textwidth]{dev/rc1/images/cube_2pop_psi_0.60_omega_30.00_r_0.50_v0_135_.solved.png} & 
    \includegraphics[width=0.3\textwidth]{dev/rc1/images/cube_2pop_psi_0.90_omega_30.00_r_0.50_v0_135_.solved.png} \\
    % 
    \rotatebox[origin=c]{90}{$\Omega=\SI{60}{\degree}$} &
    \includegraphics[width=0.3\textwidth]{dev/rc1/images/cube_2pop_psi_0.30_omega_60.00_r_0.50_v0_135_.solved.png} & 
    \includegraphics[width=0.3\textwidth]{dev/rc1/images/cube_2pop_psi_0.60_omega_60.00_r_0.50_v0_135_.solved.png} & 
    \includegraphics[width=0.3\textwidth]{dev/rc1/images/cube_2pop_psi_0.90_omega_60.00_r_0.50_v0_135_.solved.png} \\
    % 
    \rotatebox[origin=c]{90}{$\Omega=\SI{90}{\degree}$} &
    \includegraphics[width=0.3\textwidth]{dev/rc1/images/cube_2pop_psi_0.30_omega_90.00_r_0.50_v0_135_.solved.png} & 
    \includegraphics[width=0.3\textwidth]{dev/rc1/images/cube_2pop_psi_0.60_omega_90.00_r_0.50_v0_135_.solved.png} & 
    \includegraphics[width=0.3\textwidth]{dev/rc1/images/cube_2pop_psi_0.90_omega_90.00_r_0.50_v0_135_.solved.png} 
\end{tabular}
\caption[solved model images]{solved model images. inner $\SI{10}{\micro\meter}$ of the volume. \itodo{fix label}}
\label{fig:modelImages}
\end{figure}
% 
\begin{table}[!b]
\centering
\caption[Opening angle distribution]{mean and std of opening angle $d\Omega$ of the simulation model. The lower case number indicates the 10er exponent. \itodo{mean theta, mean phi}}
\pgfplotstabletypeset[%
    thesisTableStyle,
    columns={omega,psi,pop,mean,std,25,50,75},
    columns/omega/.style={column name=$\Omega/\si{\degree}$},
...
The hole dataset is available in \Cref{fig:modelHistOrientation}.
...
The \cref{tab:modelDistribution} show that for all crossing angles $\modelOmega$ the mean opening angle $<d\Omega>$ is around $\SI{20}{\degree}$ \todo{genauer wert}.
