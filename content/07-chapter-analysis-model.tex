...
% \pgfplotstabletypeset[%
%     thesisTableStyle,
%     columns={omega,psi,state, pop,mean_mean, std_mean,25_mean,50_mean,75_mean},
...
% }
\caption[Model orientation histograms]{density distribution of fiber segment orientation in initial and resulting models for $\fiberRadius = \SI{1}{\micro\meter}$. \itodo{domega?, rf=1?, logarithmisch?} \ITODO{these are only resulting models!}}
...
% 
\itodo{show images of 10micrometer cropped volumes}
% 
