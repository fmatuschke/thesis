...
\def\fiberradius{0.5}
\includegraphics[width=1.0\textwidth, page=1]{dev/gfx/2/parameter_statistic_box_plot.pdf}}
...
\resizebox{1.0\textwidth}{!}{
\def\fiberradius{0.5}
\includegraphics[width=1.0\textwidth, page=2]{dev/gfx/2/parameter_statistic_box_plot.pdf}}
\caption{at fl=3 somethings wrong with the first fr value.
Better use time, steps depends on every variable!}
% \label{fig:}
\end{figure}
