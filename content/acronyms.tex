...
\DeclareAcronym{INM-1}{short = INM-1, long = Institute of Neuroscience and Medicine for structural and functional organisation of the brain}
...
\DeclareAcronym{LMP3D}{short = LMP3D, long = large metripol 3D}
...
\DeclareAcronym{ODF}{short = ODF, long = orientation distribution function}
\DeclareAcronym{ACC}{short = ACC, long = angular correlation coefficient, short-format = \itshape}
%
...
\DeclareAcronym{JOSS}{short = JOSS, long = Journal of Open Source Software, short-format = \itshape}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Helper
%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% \newcommand{\simInc}{\textnormal{$\alpha_{\mathit{incl}}$}}
% \newcommand{\simDir}{\textnormal{$\varphi$}}
% \newcommand{\simTrel}{\textnormal{$t_\mathit{rel}$}}
