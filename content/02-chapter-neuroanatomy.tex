...
\centering
% \hspace*{\fill}
\subcaptionbox{\label{fig:brainLobes}\url{https://en.wikipedia.org/wiki/Frontal_lobe}}[.47\textwidth]{\includegraphics[height=3.25cm]{dev/wiki/brain_lobes.png}}
\hspace*{\fill}
\subcaptionbox{\label{fig:nerveFiber}\url{https://en.wikipedia.org/wiki/Association_fiber}}[.47\textwidth]{\includegraphics[height=3.25cm]{dev/wiki/brain_fiber_paths.png}}
% \hspace*{\fill}
...
$\SI{2}{\percent}$ Dimethyl sulfoxide (DMSO) and $\SI{4}{\percet}$ formaldehyde.
\par
% 
