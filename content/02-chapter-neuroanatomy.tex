...
\subcaptionbox{%
    ...
    [Gehirn B06 aus der Brain Collection]
    }[\tikzwidth]{
    ...
    \begin{tikzpicture}[every node/.style={font=\footnotesize,},]
        ...
        \begin{scope}[overlay]
            \draw[->] (rel cs:name=fig,x=0.1,y=1.05) -- (rel cs:name=fig,x=0.2,y=0.7) node[anchor=south, pos=0] {Lobus frontales};
            \draw[->] (rel cs:name=fig,x=0.4,y=1.15) -- (rel cs:name=fig,x=0.4,y=0.875) node[anchor=south, pos=0] {Sulcus centralis};
            \draw[->] (rel cs:name=fig,x=0.72,y=1.05) -- (rel cs:name=fig,x=0.6,y=0.8) node[anchor=south, pos=0] {Lobus parietalis};
            \draw[->] (rel cs:name=fig,x=1.1,y=0.85) -- (rel cs:name=fig,x=0.9,y=0.6) node[anchor=south, pos=0] {Lobus occipitalis};
            \draw[->] (rel cs:name=fig,x=0.3,y=0.1) -- (rel cs:name=fig,x=0.5,y=0.2) node[anchor=north, pos=0] {Lobus temporalis};
            \draw[->] (rel cs:name=fig,x=0.1,y=0.2) -- (rel cs:name=fig,x=0.275,y=0.3) node[anchor=north, pos=0] {Sulcus lateralis};
            \draw[->] (rel cs:name=fig,x=1.1,y=0.15) -- (rel cs:name=fig,x=0.85,y=0.2) node[anchor=north, pos=0] {Cerebellum};
        \end{scope}
...
\subcaptionbox{%
    ...
    [\tikzwidth]{\includegraphics[height=0.3\textwidth]{gfx/brain/BB_4201.png}}
