...
\centering
% \hspace*{\fill}
\subcaptionbox{\label{fig:brainLobes}Side view human brain. Frontal lobe,  Origin: \url{https://en.wikipedia.org/wiki/Frontal_lobe}}[.47\textwidth]{\includegraphics[height=3.25cm]{gfx/neuroanatomy/brain_lobes.pdf}}
\hspace*{\fill}
\subcaptionbox{\label{fig:nerveFiber}Origin: \url{https://en.wikipedia.org/wiki/Association_fiber}}[.47\textwidth]{\includegraphics[height=3.25cm]{dev/wiki/brain_fiber_paths.png}}
% \hspace*{\fill}
