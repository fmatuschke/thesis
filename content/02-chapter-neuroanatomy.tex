...
% 
The human brain (see \cref{fig:headAndBrain}) consists of three main parts: the cerebellum, located at the rear bottom, the cerebrum, located at the top, and the brainstem.
...
There are many types of cells involved in this process.
For example, some can amplify or inhibit a signal.
In the human brain there are several (billions?)
This highly interconnected structure and arrangement of different functionalities is the source of human intelligence, consistency and much more.
...
It travels through the brain to its destination, where it connects to a (perhaps more or less random) brain cell.
...
The axon is surrounded by a myelin layer, a lipid layer structure composed of nearby olegodendrides.
