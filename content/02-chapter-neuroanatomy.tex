...
\centering
% \hspace*{\fill}
\subcaptionbox{\label{fig:brainLobes}Sagital view human brain with colored lobes, Frontal, temporal, central and ocipital. Modivied version of \url{https://en.wikipedia.org/wiki/Frontal_lobe}}[.47\textwidth]{\includegraphics[height=3.25cm]{gfx/neuroanatomy/brain_lobes.pdf}}
\hspace*{\fill}
\subcaptionbox{\label{fig:nerveFiber}Sagital view of dominant fibefr pathways. Modivied version of \url{https://en.wikipedia.org/wiki/Association_fiber}}[.47\textwidth]{\includegraphics[height=3.25cm]{gfx/neuroanatomy/brain_fiber_paths.pdf}}
% \hspace*{\fill}
