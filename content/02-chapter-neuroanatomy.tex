...
\centering
% \hspace*{\fill}
\subcaptionbox{\label{fig:brainLobes}Sagital view of the human brain with lobes colored in: {\color[RGB]{117,112,179}frontal}, {\color[RGB]{230,171,2}parietal}, {\color[RGB]{27,158,119}temporal} and {\color[RGB]{231,41,138}occipital} lobe. The {\color[RGB]{102,166,30}cerebellum} is at the bottom, with the {\color[RGB]{217,95,2}brainstem} next to it. Modivied version of \url{https://en.wikipedia.org/wiki/Frontal_lobe}}[.47\textwidth]{\includegraphics[height=3.25cm]{gfx/neuroanatomy/brain_lobes.pdf}}
\hspace*{\fill}
\subcaptionbox{\label{fig:nerveFiber}Sagital view of exemplary dominant fiber pathways. Modivied version of \url{https://en.wikipedia.org/wiki/Association_fiber}}[.47\textwidth]{\includegraphics[height=3.25cm]{gfx/neuroanatomy/brain_fiber_paths.pdf}}
% \hspace*{\fill}
\caption{Illustration of the human brain with lobes \subref{fig:brainLobes} and fiber pathways \subref{fig:nerveFiber}.}
...
\node[anchor=south west] (F) at (0,0) {\includegraphics[angle=90,width=0.75\textwidth,]{gfx/neuroanatomy/neuron-axon.pdf}};
\begin{scope}[overlay]
    % \draw[] (0,0) grid (11,6);
...
A typical nerve cell (see \cref{fig:human-brain}) \todo{if there is such a thing} has a cell body, called a soma, that processes incoming information.
