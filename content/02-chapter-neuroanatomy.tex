...
The diameter of the myelin ranges from about $\SI{0.5}{\micro\meter}$ to several micrometer (see \cref{tab:axonDiameter}).
...
\begin{figure}[!t]
    ...
    \subcaptionbox{%
        ...
        In between \textcolor{ProcessBlue}{net-like structures} are fromed from individual nerve fibers.
