...
\subcaptionbox{%
    ...
    \begin{tikzpicture}[every node/.style={font=\footnotesize,},]
        ...
        \begin{scope}[overlay]
            \draw [RED,very thick, decorate, decoration = {brace}]
                (rel cs:name=fig,x=0.39,y=0.625) -- 
                (rel cs:name=fig,x=0.59,y=0.625) 
                node[anchor=south, pos=0.35] {%
                    \shadowoffset{0.25pt}
...
\end{figure}
% TODO: vermutlich nicht vom BB!
\addtocounter{footnote}{-1}\footnotetext{Illustration of side view from B06 from the brain collection of the \acs{INM-1}.}
\addtocounter{footnote}{+1}\footnotetext{Coronal stained section 4201 from the J{\"u}lich BigBrain Project \cite{Amunts2013}.}
%
