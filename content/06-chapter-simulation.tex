...
\caption[Discretization error]{Discretization error. This behavier is much stronger with myelin layers}
...
\centering
\resizebox{0.75\textwidth}{!}{
\inputtikz{dev/gfx/1/optical_axis_high_2_r.tex}}
...
\centering
\resizebox{0.75\textwidth}{!}{
\inputtikz{dev/gfx/1/optical_axis_high_norm_2_r.tex}}
\caption{Discretization error}
\label{fig:vectorfield_disc}
\end{figure}
% 
...
\centering
\resizebox{0.75\textwidth}{!}{
\inputtikz{dev/gfx/1/vdiff_2_r.tex}}
\caption{Discretization error}
\label{fig:vectorfield_disc}
\end{figure}
% 
...
\centering
\resizebox{0.75\textwidth}{!}{
\inputtikz{dev/gfx/1/vf_diff_2_r.tex}}
\caption{Discretization error}
\label{fig:vectorfield_disc}
\end{figure}
% 
...
\centering
\resizebox{0.75\textwidth}{!}{
\inputtikz{dev/gfx/1/vf_intp_norm_2_r.tex}}
\caption{Discretization error}
\label{fig:vectorfield_disc}
\end{figure}
% 
