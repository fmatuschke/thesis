...
%
% CROSSING
The crossing fiber population \cfbs{} in \cref{fig:timeDevelopmentCross} shows an equaly linear behavier for all parameter sets for the number of steps as in the case of the single fiber population.
...
Not only does this mean that the fiber segments that need to be moved out of the way are longer, but also that in hiher octree levels the segments cannot be seperated anymore and therefore exists in multiple leafs.
