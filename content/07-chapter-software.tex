...
The wiki page is structured as a guide that walks through the aspects of designing nerve fiber models, applying the collision solver algorithm, visualizing nerve fibers, a introduction in \ac{3D-PLI}, and finally applying the models in the simulation.
