...
\par
% 
In addition, the \name{Github actions} run all test scripts, check tutorial files, check code format and linting for consistency, and publish the latest documentation after a sucessfully tested release.
\par
%
...
\par
% 
Each class provides member funtions to \code{translate}, \code{rotate}, \code{scale}, and \code{cut} the model.
