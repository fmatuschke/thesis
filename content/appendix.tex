...
%     thesisTableStyle,
%     skip rows between index={62}{184},
...
%     % 
% ]
% {dev/rc1/omegas_ms.csv}
% }
% \label{tab:modelDistributionFull}
% \end{table}
% % 
% \begin{table*}[p]
% \centering
...
% \pgfplotstabletypeset[%
%     thesisTableStyle,
%     skip rows between index={1}{61},
%     skip rows between index={124}{184},
%     columns={omega,psi,pop,incl_mean,incl_std,incl_25,incl_50,incl_75,phi_mean,phi_std,phi_25,phi_50,phi_75,mean,std,25,50,75},
%     every head row/.style={
%         before row={
%             \toprule
