...
\begin{scope}[overlay]
    \draw[->,thick] (image.north west) -- ++(1,0) node [midway, above] {$\Omega$};
    \draw[->,thick] (image.north west) -- ++(0,-1) node [midway, above, rotate=90] {$\Psi$};
\end{scope}
...
\begin{scope}[overlay]
    \draw[->,thick] (image.north west) -- ++(1,0) node [midway, above] {$\mathfrak{f}_0^\alpha$};
    \draw[->,thick] (image.north west) -- ++(0,-1) node [midway, above, rotate=90] {$\mathfrak{f}_0^\Psi$};
\end{scope}
\path ($(image.north west) + (-.5,.5)$) -- ($(image.north east) + (.5,.5)$);
\end{tikzpicture}
}
...
\begin{scope}[overlay]
    \draw[->,thick] (image.north west) -- ++(1,0) node [midway, above] {$f_0$};
    \draw[->,thick] (image.north west) -- ++(0,-1) node [midway, above, rotate=90] {$\Psi$};
\end{scope}
\path ($(image.north west) + (-.5,.5)$) -- ($(image.north east) + (.5,.5)$);
\end{tikzpicture}
