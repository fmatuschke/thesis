...
\centering
\resizebox{\textwidth}{!}{
\includegraphics[page=2]{dev/rc1/images/cube_2pop_images_output_cube_2pop_135_rc1.pdf}}
...
\rotatebox{90}{
\begin{tabular}{c|c}
    \includegraphics[page=2]{dev/rc1/analysis/plots_single_pop_hist_output_cube_2pop_135_rc1_single.pdf}
    &
    \includegraphics[page=3]{dev/rc1/analysis/plots_single_pop_hist_output_cube_2pop_135_rc1_single.pdf}
\end{tabular}
}}
%
...
\resizebox{\textwidth}{!}{
\begin{tabular}{c|c}
    \includegraphics[page=1]{dev/rc1/analysis/plots_flat_pop_hist_output_cube_2pop_135_rc1_flat.pdf}&
    \includegraphics[page=2]{dev/rc1/analysis/plots_flat_pop_hist_output_cube_2pop_135_rc1_flat.pdf} \\
    \includegraphics[page=3]{dev/rc1/analysis/plots_flat_pop_hist_output_cube_2pop_135_rc1_flat.pdf} &
    \includegraphics[page=4]{dev/rc1/analysis/plots_flat_pop_hist_output_cube_2pop_135_rc1_flat.pdf} \\
    \includegraphics[page=5]{dev/rc1/analysis/plots_flat_pop_hist_output_cube_2pop_135_rc1_flat.pdf} &
    \includegraphics[page=6]{dev/rc1/analysis/plots_flat_pop_hist_output_cube_2pop_135_rc1_flat.pdf} \\
    \includegraphics[page=7]{dev/rc1/analysis/plots_flat_pop_hist_output_cube_2pop_135_rc1_flat.pdf} &
    \includegraphics[page=8]{dev/rc1/analysis/plots_flat_pop_hist_output_cube_2pop_135_rc1_flat.pdf} \\
    \includegraphics[page=9]{dev/rc1/analysis/plots_flat_pop_hist_output_cube_2pop_135_rc1_flat.pdf} &
    \includegraphics[page=10]{dev/rc1/analysis/plots_flat_pop_hist_output_cube_2pop_135_rc1_flat.pdf}
\end{tabular}
}
%
...
\resizebox{\textwidth}{!}{
\begin{tabular}{c|c}
    \includegraphics[page=1]{dev/rc1/analysis/plots_inclined_pop_hist_output_cube_2pop_135_rc1_inclined.pdf} &
    \includegraphics[page=2]{dev/rc1/analysis/plots_inclined_pop_hist_output_cube_2pop_135_rc1_inclined.pdf} \\
    \includegraphics[page=3]{dev/rc1/analysis/plots_inclined_pop_hist_output_cube_2pop_135_rc1_inclined.pdf} &
    \includegraphics[page=4]{dev/rc1/analysis/plots_inclined_pop_hist_output_cube_2pop_135_rc1_inclined.pdf} \\
    \includegraphics[page=5]{dev/rc1/analysis/plots_inclined_pop_hist_output_cube_2pop_135_rc1_inclined.pdf} &
    \includegraphics[page=6]{dev/rc1/analysis/plots_inclined_pop_hist_output_cube_2pop_135_rc1_inclined.pdf} \\
    \includegraphics[page=7]{dev/rc1/analysis/plots_inclined_pop_hist_output_cube_2pop_135_rc1_inclined.pdf} &
    \includegraphics[page=8]{dev/rc1/analysis/plots_inclined_pop_hist_output_cube_2pop_135_rc1_inclined.pdf} \\
    \includegraphics[page=9]{dev/rc1/analysis/plots_inclined_pop_hist_output_cube_2pop_135_rc1_inclined.pdf} &
    \includegraphics[page=10]{dev/rc1/analysis/plots_inclined_pop_hist_output_cube_2pop_135_rc1_inclined.pdf}
\end{tabular}
}
%
\caption[sim]{psi=0.3; left: 2d log histogramm orientation from rofl analysis of simulation, right: 2d log histogram of orientation of model segemnts. \todo{legende}}
