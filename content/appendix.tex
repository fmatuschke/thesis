...
\begin{table}[!ht]
\centering
\caption{Orientation statistic of simulation model library.}
\resizebox{\textwidth}{!}{
...
\caption{Simulation model library. The inner $\SI{10}{\micro\meter} \times \SI{10}{\micro\meter} \times \SI{10}{\micro\meter}$ of the volume is shown.}
