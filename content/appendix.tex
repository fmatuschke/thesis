...
\begin{figure}[!p]
    \centering
    \includegraphics[width=\textwidth]{gfx/rc1/mpara/pre_stats_box_plot_volume_all_output_parameter_statistic_rc1.pdf}
...
\begin{sidewaysfigure}[!p]
    \centering
    \begin{tabular}{cc}
    \includegraphics[page=1,height=\tikzwidth]{gfx/rc1/analysis/plots_flat_pop_output_cube_2pop_135_rc1_flat.pdf} &
    \includegraphics[page=2,height=\tikzwidth]{gfx/rc1/analysis/plots_flat_pop_output_cube_2pop_135_rc1_flat.pdf}
    \end{tabular}
    \caption{Flat crossing fiber population.
    Results of the simulation analysis with comparison of the fiber models orientations (see \cref{sec:resCrossFlat}).}
...
\begin{sidewaysfigure}[!p]
    \centering
    \begin{tabular}{cc}
    \includegraphics[page=3,height=\tikzwidth]{gfx/rc1/analysis/plots_flat_pop_output_cube_2pop_135_rc1_flat.pdf} &
    \includegraphics[page=4,height=\tikzwidth]{gfx/rc1/analysis/plots_flat_pop_output_cube_2pop_135_rc1_flat.pdf}
    \end{tabular}
...
\begin{sidewaysfigure}[!p]
    \centering
    \begin{tabular}{cc}
    \includegraphics[page=5,height=\tikzwidth]{gfx/rc1/analysis/plots_flat_pop_output_cube_2pop_135_rc1_flat.pdf} &
    \includegraphics[page=6,height=\tikzwidth]{gfx/rc1/analysis/plots_flat_pop_output_cube_2pop_135_rc1_flat.pdf}
    \end{tabular}
    \caption{Flat crossing fiber population. Results of the simulation analysis with comparison of the fiber models orientations (see \cref{sec:resCrossFlat}).}
...
\begin{sidewaysfigure}[!p]
    \centering
    \begin{tabular}{cc}
    \includegraphics[page=7,height=\tikzwidth]{gfx/rc1/analysis/plots_flat_pop_output_cube_2pop_135_rc1_flat.pdf} &
    \includegraphics[page=8,height=\tikzwidth]{gfx/rc1/analysis/plots_flat_pop_output_cube_2pop_135_rc1_flat.pdf}
    \end{tabular}
    \caption{Flat crossing fiber population. Results of the simulation analysis with comparison of the fiber models orientations (see \cref{sec:resCrossFlat}).}
...
\begin{sidewaysfigure}[!p]
    \centering
    \begin{tabular}{cc}
    \includegraphics[page=1,height=\tikzwidth]{gfx/rc1/analysis/plots_inclined_pop_output_cube_2pop_135_rc1_inclined.pdf} &
    \includegraphics[page=2,height=\tikzwidth]{gfx/rc1/analysis/plots_inclined_pop_output_cube_2pop_135_rc1_inclined.pdf}
    \end{tabular}
...
\begin{sidewaysfigure}[!p]
    \centering
    \begin{tabular}{cc}
    \includegraphics[page=3,height=\tikzwidth]{gfx/rc1/analysis/plots_inclined_pop_output_cube_2pop_135_rc1_inclined.pdf} &
    \includegraphics[page=4,height=\tikzwidth]{gfx/rc1/analysis/plots_inclined_pop_output_cube_2pop_135_rc1_inclined.pdf}
    \end{tabular}
    \caption{Population of inclined crossing fibers. Results of the simulation analysis with comparison of the fiber models orientations (see \cref{sec:resInclCross}).}
...
\begin{sidewaysfigure}[!p]
    \centering
    \begin{tabular}{cc}
    \includegraphics[page=5,height=\tikzwidth]{gfx/rc1/analysis/plots_inclined_pop_output_cube_2pop_135_rc1_inclined.pdf} &
    \includegraphics[page=6,height=\tikzwidth]{gfx/rc1/analysis/plots_inclined_pop_output_cube_2pop_135_rc1_inclined.pdf}
    \end{tabular}
    \caption{Population of inclined crossing fibers. Results of the simulation analysis with comparison of the fiber models orientations (see \cref{sec:resInclCross}).}
...
\begin{sidewaysfigure}[!p]
    \centering
    \begin{tabular}{cc}
    \includegraphics[page=7,height=\tikzwidth]{gfx/rc1/analysis/plots_inclined_pop_output_cube_2pop_135_rc1_inclined.pdf} &
    \includegraphics[page=8,height=\tikzwidth]{gfx/rc1/analysis/plots_inclined_pop_output_cube_2pop_135_rc1_inclined.pdf}
    \end{tabular}
    \caption{Population of inclined crossing fibers. Results of the simulation analysis with comparison of the fiber models orientations (see \cref{sec:resInclCross}).}
