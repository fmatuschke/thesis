...
The \ac{CCD} image array however has a size of $int(round((\voi_x,\voi_y)/\voxelsize))$.
...
For the trivial case that the sample is not tilted, this is simply the \ac{CCD} array element centered.\todo{supersampling}
...
% 
\itodo{smart sampling spæter diskutieren}