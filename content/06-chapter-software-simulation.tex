...
\textcolor{gray}{
\begin{itemize}
    \item what is a dis. volume
    \item how to represent a fiber segment
    \item layer
    \item optical axis
...
\par
% 
To discretice the previous defined nerve fiber models (see \cref{chap:sof:modelling}), the problem can be reduced to a single nerve fiber segment (except the boundry effects).
% 
