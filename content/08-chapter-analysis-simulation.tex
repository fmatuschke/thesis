...
However, since in the analysis the transmittance is not presents (see \dummy{}) and its role only indicates, how large the nois distribution is (which is for this setup quite small), this ... should be ok.
...
\begin{figure}[!tp]
\centering
\includegraphics[width=\textwidth]{dev/rc1/single/PM_Vervet_r_r_0.50_o_60_f0_0.00_f1_0.00_.init.pdf} 
\caption[hist]{\dummy{}}
