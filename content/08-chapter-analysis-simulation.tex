...
\Cref{tab:simParameters} lists the parameters of the simulation in the variable notation \ac{fastPLI}.
...
\\
%
The simulation, on the other hand, has a very good speedup to $\SI{48}{\cpus}$ for both the \ac{MPI} and the \ac{OpenMP}.
