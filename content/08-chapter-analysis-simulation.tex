...
\subcaptionbox{\label{fig:human:transmittance} transmittance\itodo{check crange}}[0.84\textwidth]{
% \fbox{
...
\draw[magenta, very thick, ->] (axis cs: 650,175) -- (axis cs: 586,265);
...
\\[2em]
\subcaptionbox{retardation}[0.84\textwidth]{
\begin{tikzpicture}[trim axis left, trim axis right]
\begin{axis}[%
width=0.84\textwidth,
% title = {$B_1^{equ}$ in $\mu T$},
