...
\begin{figure}[!t]
\centering
\subcaptionbox{\label{fig:usaf_image}microscopig image}[.45\textwidth]{
...
\end{tikzpicture}
\hfill}
\subcaptionbox{\label{fig:usaf_lines}line plots. \itodo{single line plots not good}}[.45\textwidth]{
\begin{tikzpicture}[baseline]
\begin{axis}[%
axis x line = center,
axis y line = center,
