...
% 
To measure the resolution a \textit{1951 \ac{USAF} resolution test chart}\footnote{U.S. Air Force MIL-STD-150A standard of 1951} is acquired.
...
The intensity line profiles are shown in \cref{fig:usaf_lines_lr,fig:usaf_lines_ud}.
% 
...
\begin{figure}[!tp]
\centering
\includegraphics[width=\textwidth]{dev/rc1/single/PM_Vervet_r_r_0.50_f0_0.00_f1_0.00_.init.pdf} 
\caption[hist]{\dummy{}}
\label{fig:single_fiber_hist_with_gt}
\end{figure}
% 
\begin{figure}[!tp]
\centering
