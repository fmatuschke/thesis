...
\subcaptionbox{hist transmittance}{\includegraphics[width=0.45\textwidth]{dev/rc1/data/transmittance_vervet_cc_hist.png}}
\hspace*{\fill}
\\
\hspace*{\fill}
\subcaptionbox{zoom retardation}{\inputtikz{gfx/data/vervet_retardation_zoom}}\hfill
\subcaptionbox{hist retardation}{\includegraphics[width=0.45\textwidth]{dev/rc1/data/retardation_vervet_cc_hist.png}}
\hspace*{\fill}
...
\caption{two population model library \itodo{centering} \itodo{e und f fertig machen, beispiel inc=30, zwei symmetrien darstelen}}
