...
This is easyest to be done from areas of flat fiber regions.
...
However it should be a good estimate ofthe order of absorption in the tissue, which will later shown in the simulation is already sufficient.
% 
% 
% 
