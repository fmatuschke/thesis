...
\centering
\hspace*{\fill}
\subcaptionbox{zoom transmittance}{\includegraphics[width=0.45\textwidth]{dev/gfx/data/transmittance_vervet_cc_0_8339.png}}\hfill
\subcaptionbox{hist transmittance}{\includegraphics[width=0.45\textwidth]{dev/gfx/data/transmittance_vervet_cc_hist.png}}
\hspace*{\fill}
\\
\hspace*{\fill}
\subcaptionbox{zoom retardation}{\includegraphics[width=0.45\textwidth]{dev/gfx/data/retardation_vervet_cc_0.000_0.996.png}}\hfill
\subcaptionbox{hist retardation}{\includegraphics[width=0.45\textwidth]{dev/gfx/data/retardation_vervet_cc_hist.png}}
\hspace*{\fill}
\caption[zoom ret and trans]{%
left trans: 1168+-501, right trans: 1175+-511, left ret: 0.83+-0.07, right ret: 0.80+-0.07
