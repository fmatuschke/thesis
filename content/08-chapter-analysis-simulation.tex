...
\itodo{retardation in PM higher!}
% 
\begin{figure}[!t]
...
xmin=0.5,xmax=1525.5,
ymin=0.5,ymax=995.5,
y dir=reverse,
point meta min=6567,
point meta max=14085,
hide axis,
colormap/blackwhite,
colorbar,
% colorbar horizontal,
...
% % /pgf/number format/precision=2,
% % xlabel= {\si{\arbitraryunit}},
% x label style = {at={(current axis.south)},above=-5mm, anchor = north}},
]
...
\begin{figure}[p]
\centering
\includegraphics[width=\textwidth, page=8]{dev/gfx/2/voxel_size_plots_0.pdf}
\caption[]{\dummy{}}
\label{fig:voxelsize}
\end{figure}
% 
\begin{figure}[p]
\centering
\includegraphics[width=\textwidth, page=8]{dev/gfx/2/voxel_size_plots_1.pdf}
\caption[]{\dummy{}}
\label{fig:voxelsize}
\end{figure}
% 
