...
\end{axis}
\end{tikzpicture}
\caption[]{MPI speedup discrete tissue generation. \itodo{einheitlicher style}}
\end{figure}
% 
% 
\begin{figure}[!t]
...
\end{axis}
\end{tikzpicture}
\caption[]{MPI Speedup simulation for 5 tilt direction. \itodo{einheitlicher style}}
\end{figure}
% 
% 
% OPENMP
...
\addplot+[only marks] table[x index=1, y index=3] {dev/rc1/speed/generate_mp_tissue_v_0.1.dat};
\addplot[black, dashed] coordinates {(1,1) (5,5)} node[pos=0.9, sloped, anchor=north] {ideal};
\end{axis}
\end{tikzpicture}
\caption[]{OpenMP speedup discrete tissue generation. \itodo{einheitlicher style}}
\end{figure}
% 
% 
\begin{figure}[!t]
...
\addplot+[only marks] table[x index=1, y index=8] {dev/rc1/speed/simulation_mp_v_0.1.dat}; \addlegendentry{flat}
\addplot+[only marks] table[x index=1, y index=9] {dev/rc1/speed/simulation_mp_v_0.1.dat}; \addlegendentry{W}
\addplot+[only marks] table[x index=1, y index=10] {dev/rc1/speed/simulation_mp_v_0.1.dat}; \addlegendentry{S}
\addplot+[only marks] table[x index=1, y index=11] {dev/rc1/speed/simulation_mp_v_0.1.dat}; \addlegendentry{E}
\addplot+[only marks] table[x index=1, y index=12] {dev/rc1/speed/simulation_mp_v_0.1.dat}; \addlegendentry{N}
\addplot[black, dashed] coordinates {(1,1) (42,42)} node[pos=0.9, sloped, anchor=south] {ideal};
\end{axis}
\end{tikzpicture}
\caption[]{OpenMP Speedup simulation for 5 tilt direction. \itodo{einheitlicher style}}
\end{figure}
% 
\dummy{}\dummy{}\dummy{}
%  
...
\cref{sec:resInclCross}
\dummy{}
% 
\subsection{Free crossing fiber population}
\cref{sec:resFreeCross}
\dummy{}
% 
\subsection{Speedup} 
\cref{sec:simSpeedup}
