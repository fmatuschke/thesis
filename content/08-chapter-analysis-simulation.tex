...
The focus of the evaluations of the results is on the accuracy of the inclination analysis for different orientations and crossing configurations.
%
%
%
...
\caption{Crossing flat fiber population: $\modelPsi=\SI{30}{\percent}$. Inclination analysis results. \todo{domega, trel}}
...
It should be noted that the change in the signal that fits the inclination analysis is the same for the non-inclined measurement as for the four inclined measurements.
...
\par
%
In the case of a single fiber population, the resulting inclination analysis shows good agreement with the individual orientations of the model, except for very steeply inclined configurations.
%
