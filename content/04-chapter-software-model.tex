...
Only the surface of a sphere, which is not colliding with another sphere is ... as the surcace of the entire cell (see \cref{ig:medusaCell}).
...
Analog to the \dummy{} algorithm the collisions of the bjects are then checked and slighlty pushed appart until no more collisions can be detected.
% 
% % ------------------------------------------------------------------------------
% \par
