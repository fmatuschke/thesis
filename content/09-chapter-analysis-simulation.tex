...
\par
% 
$\modelPsi=\SI{70}{\percent}$ shows the same behavior as for the $\modelPsi=\SI{50}{\percent}$ case, however, the reduction is not as strong as in the previous case.
...
\end{figure}
% 
Overall the opening angle \openingAngle{} shows relativly low values for most fiber population fractions \modelPsi{} and inclination angles \modelInc{}.
