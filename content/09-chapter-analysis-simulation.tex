...
\hfill
\subcaptionbox{
A resulting value for a fiber population of inclination $\modelInc$ and secondary fiber population with crossing angle $\modelOmega$ and rotation $\modelRot$ will be plotted at the corresponding position in the polar plot.
}
