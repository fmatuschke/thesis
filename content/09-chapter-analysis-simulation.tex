...
This, however, does not mean that the resulting orientation is the orientation of the underlying fibers, as it can seen in the results of the direction and inclination.
