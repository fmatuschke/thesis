...
The models to be simulated are parallel models without inclination $\pfbs, \modelInc = \SI{0}{\degree}$, inclined parallel fiber models $\pfbs, \modelInc = \SI{90}{\degree}$, flat crossing fiber models $\cfbs, \modelInc = \SI{0}{\degree}$, and crossing inclined fiber modls $\cfbs, \modelInc = \SI{90}{\degree}$ with a fraction of $\modelPsi = \SI{0.5}{}$, since these configurations represent the extrema for two fiber populations.
