...
\section{Simulation}
%
\subsection{Environment/Setup/...} %TODO
...
For the distribution of the angular statistic these however have to be handled with care, since the values are periodic.
To overcome this problem the values are centered around the circular mean value in the range of $\big[\circmean (\xi)-\SI{90}{\degree}, \circmean(\xi)+\SI{90}{\degree}\big)$. where $\xi$ is the parameter.
