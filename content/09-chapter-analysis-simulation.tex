...
\par
%
\Cref{fig:single_fiber_pop_rofl} show the modalities transmittance, direction and retardation of the flat measurement as well as the results of the tilt analysis inclination, \trel{}, the resulting opening angle $\openingAngle$, the \accvalue{} and \rvalue{}.
% 
%Transmittance
...
In the background of the boxplots the statistical ranges of the model orientations of $\SIrange{25}{75}{\percent}$ are plotted.
These show good agreement with the measured direction, with the exception of the case $\modelInc=\SI{90}{\degree}$, the variance of the measurements is significantly lower.
\par
%
% Inclination
...
In the background again the quantiles $\SIrange{25}{75}{\percent}$ of the model segments are shown.
The variance is constant and up to a value of $\SI{75}{\percent}$ higher than the measured values.
\par
%
% trel
...
The models opening angle range in the background show a significant higher value and higher variance.
\par
% 
%ACC
...
\caption{Crossing flat fiber population: $\modelPsi=\SI{30}{\percent}$. Results of the simulation analysis compared with the orientations of the models.}
...
\caption{Crossing flat fiber population: $\modelPsi=\SI{50}{\percent}$. Results of the simulation analysis compared with the orientations of the models.}
\label{fig:flat_05_fiber_pop_rofl}
\end{figure}
% 
\Cref{fig:flat_03_fiber_pop_rofl,fig:flat_05_fiber_pop_rofl} show the results of the \ac{3D-PLI} modalities, the tilt analysis, opening angle, \accvalue{} and \rvalue{} in detail.
\par
% Transmittance
...
The variance of the underlying fiber models is overall significantly higher than the direction of the simulations.
Lower directional values of the models are more frequent than higher values compared to the crossing angle.
For $\modelPsi=\SI{30}{\percent}$ this behavior is maximal in the range of a crossing angle $\modelOmega = \SIrange{40}{80}{\degree}$.
In the case of $\modelPsi=\SI{50}{\percent}$ the variance lies almost exactly in between the direction of both fiber population.
\par
% Inclination
...
The variance of the model inclinations is in agreement with the simulation results for the lowest crossing angle.
For higher values, the variance increases significantly and remains almost stable for the further crossing angles.
For all crossing angles, the variance of the models is significantly higher than that of the simulation results.
\par
% Trel
