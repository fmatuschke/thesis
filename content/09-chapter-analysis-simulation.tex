...
From there on the \trel{} value decrasisn up to a inclination angle of $\modelInc=\SI{85}{\degree}$ and increases significant for $\modelInc = \SI{90}{\degree}$.
...
At a inclination angle of $\SI{90}{\degree}$ the maximum \accvalue{} is reached.
%
%
%
...
The seconds fiber population inclination angle will be identical with the crossing angle \modelOmega{} between both fiber populations.
\par
%
\begin{figure}[!p]
\centering
...
The orientation of the tilt analysis of the simulation follows the inclination of the models, with the exception for a crossing angle $\modelOmega = \SI{90}{\degree}$.
...
The increase of the transmittance slows down for higher crossing angles \modelOmega{}.
\par
% Retardation
The retardation is negatively linearly correlated with increasing crossing angle \modelOmega{}.
The slope of the negative correlation is higher with increasing fiber population fraction \modelPsi{}.
The variance increases as the crossing angle increases and increasing fiber population fraction.
\par
% Direction
The direction value is centered around $\SI{0}{\degree}$.
The variance of the direction increases with increasing crossing angle \modelOmega{}.
The fiber popilation fraction has no significant effect except for a value of $\modelPsi = \SI{10}{\percent}$ and a crossing angle of $\modelOmega=\SI{90}{\percent}$.
...
The \bvariance{} variance for \popa{} increases up to a crossing angle of about $\modelOmega = \SI{50}{\degree}$ and remains constant for higher crossing angles, whereas the \bvariance{} variance of the second fiber bundle increases further.
\par
% Inclination
The inclination results have the shape of a convex curve, starting and ending at a value of $\inc\SI{0}{\degree}$.
Depending on the fiber population fraction \modelPsi{} the maximum of the curve is shifted towords a crossing angle of $\SI{90}{\degree}$ for a low \modelPsi{} and towortds $\SI{45}{\degree}$ for a high \modelPsi{}.
The \bvariance{} of the individual nerve fiber populations remain constant for crossing angles $\geq \SI{10}{\degree}$. 
For lower fiber population fractions \modelPsi{} and higher crossing angles \modelOmega{} the variance of the simulation results is higher than the \bvariance{} of the models.
Otherwise the simulations inclination variance is significantly lower.
\par
% Trel
The relative thickness \trel{} decreases linearly with increasing crossing angle \modelOmega{}.
...
In variance of the \trel{} value is increased at about $\modelOmega=\SI{45}{\degree}$ for lower fiber population fractions and towords $\modelOmega=\SI{90}{\degree}$ for high fiber population fractions.
\par
% r-value
...
With increasing crossing angle \modelOmega{} the \rvalue{} and its variance increases slightly for lower fiber population fractions and more strongly for higher fiber population fractions..
\par
% domega
The measured opening angle \openingAngle{} mean value as its variance increases slightly with increasing crossing angle.
For lower fiber population fractions and a crosing angle $\modelOmega\geq \SI{80}{\degree}$ the increas is significant more.
...
\par
% acc-value
The \accvalue{} show a decrease with increasing crossing angle to a minimum value and from there the \accvalue{} raises agein..
The position of the minimum depends strongly on the fiber population fraction.
For lower \modelPsi{} the minimum is close to higher crossing angles and for higher \modelPsi{} the minimum moves to a crossing angle of about $\modelOmega\approx\SI{45}{\degree}$.
...
\end{figure}
%
In this section, two nerve fiber populations \popa{} and \popb{} are simulated with sampled orientations on a sphere (see \cref{fig:twomodelpopdesign,tab:simParameters})
