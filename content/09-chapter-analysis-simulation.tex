...
\caption{Population of inclined crossing fibers: $\modelPsi=\SI{30}{\percent}$. Results of the simulation analysis with comparison of the fiber models orientations. \todo{change title}}
...
\caption{Population of inclined crossing fibers: $\modelPsi=\SI{50}{\percent}$. Results of the simulation analysis with comparison of the fiber models orientations. \todo{change title}}
...
No significant effect is seen between the analysed direction between both fiber population fractions.
The \bvariance{} of the individual fiber segments is significant higher than the measuments and increases with increasing crossing angle \modelOmega{} in both cases.
The median of the fiber model stays at $\dir=\SI{0}{\degree}$.
\par
% Inclination
