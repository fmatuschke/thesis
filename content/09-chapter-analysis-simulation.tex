...
\par
%
\TODO{Order of results, \eg{} t,r <- mod; d,i,trel,R <- rofl; omega,acc <- orientation statistic?}
% 
...
The other proportions of the fiber population are available in \cref{app:flat_fiber_pop_a,app:flat_fiber_pop_b,app:flat_fiber_pop_c,app:flat_fiber_pop_d,app:flat_fiber_pop_e}.
\par
%
...
% 
\todo{same order of parameters as befor}
%
...
\begin{figure}[!p]
    ...
    \caption{Mean \trel{} from tilt analysis. \todo{add $>=1$}}
...
These results reproduce the previous results \todo{cite} and show that with this distribution of fiber radii at this resulution individual fiber population for a intervowen dense fiberbundle cannot be distinguished.
