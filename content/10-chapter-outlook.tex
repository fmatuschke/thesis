...
As a first implementation a collision detection algorithm on the \ac{GPU}, an uniaxial aligned collision search algorithm \cite{Karras2012} was implemented.
