...
\draw[thick, arrows={Latex[scale=1]-Latex[scale=1]}] (-1, 0) -- (1, 0);
...
\draw[thick, arrows={Latex[scale=1]-Latex[scale=1]}] (0, -1) -- (0, 1);
...
\draw[thick, arrows={Latex[scale=1]-Latex[scale=1]}] (-1, -1) -- (1, 1);
...
\draw[thick, arrows={-Latex[scale=1]}] plot[domain=44:45,samples=1] ({cos(\x)},{sin(\x)});
\draw[thick, arrows={-Latex[scale=1]}] plot[domain=224:225,samples=1] ({cos(\x)},{sin(\x)});
...
\draw[thick] plot[domain=0:360,samples=90,smooth] ({cos(\x)},{sin(\x)});
\draw[thick, arrows={-Latex[scale=1]}] plot[domain=46:45,samples=1] ({cos(\x)},{sin(\x)});
\draw[thick, arrows={-Latex[scale=1]}] plot[domain=226:225,samples=1] ({cos(\x)},{sin(\x)});
\draw[] (0, -2) node () {$\begin{pmatrix} 1&-i \end{pmatrix}$};
\draw[] (0, -3) node () {$\begin{pmatrix} 1&0&0&1 \end{pmatrix}$};
\end{tikzpicture}
}
